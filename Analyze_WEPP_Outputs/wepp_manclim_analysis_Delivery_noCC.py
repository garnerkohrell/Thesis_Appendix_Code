...
def analyze_sed_del(wshed,SDR,TMDL_SD,TMDL_RO,mod_lst,ymin,ymax,per_adopt_lst,wshed_name):
    ...
    def graph_prepped_data(graphed_var, TMDL_val, y_lab):
        ...
        for scen_lst, adopt_lst, subx, suby, scen_name in zip(scen_types,adopt_rates,subx_vals,suby_vals, scen_names):
            ...
            def create_plot(df,mod,point_shape,color):
                ...
                #set horizontal line for TMDL
                if scen_name == 'Perennial Integration' or scen_name == 'Perennial Integration with 100% Consv. Till.' or scen_name =='Conservation Tillage':
    ...
    graph_prepped_data('runoff', TMDL_RO, 'Average Total Hillslope Runoff (mm)')
    ...
    fig.savefig('C:/Users/Garner/Soil_Erosion_Project/WEPP_PRWs_final/Future_Man_Outputs/Runoff/{}_noCC.png'.format(wshed), bbox_inches = "tight")
